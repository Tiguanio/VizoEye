...
**VizoEye** — это интеллектуальный помощник для незрячих и слабовидящих людей, который использует современные нейросети для описания окружающего мира. 
